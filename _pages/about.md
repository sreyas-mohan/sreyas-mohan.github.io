...
Publications
-----
+ **Robust and Interpretable Blind Image Denoising via Bias-free Convolutional Neural Networks. Sreyas Mohan <sup>\*</sup>**, Zahra Kadkhodaie <sup>\*</sup>, Eero Simoncelli, Carlos Fernandez-Granda <br/>
...
+ **Data-driven Estimation of Sinusoid Frequencies.** Gautier Izacard, **Sreyas Mohan**, Carlos Fernandez-Granda <br/>
...
+ **Automatic Knee Segmentation using Diffusion Weighted MRI.** Alejandra Duarte <sup>\*</sup>, Chaitra Hegde <sup>\*</sup>, Aakash Kaku <sup>\*</sup>, **Sreyas Mohan <sup>\*</sup> **, Jose G Raya\
...
+ **Data Driven Coded Aperture Design for Depth Recovery.** Prasan Shedligeri, **Sreyas Mohan**, Kaushik Mitra \
*IEEE International Conference on Image Processing (ICIP), Sep 2017, Beijing, China.*
+ **Blind Nonnegative Source Separation Using Biological Neural Networks.** Cengiz Pehlevan, **Sreyas Mohan**, Dmitri B. Chklovskii\
